...
import { ModelGenerationResult } from '@/types/ai-models';
...
interface MultiModelGenerationResultsProps {
  results: ModelGenerationResult[];
  onSelectResult: (result: ModelGenerationResult) => void;
  onDiscardResult?: (result: ModelGenerationResult) => void;
}

export function MultiModelGenerationResults({
  results,
  onSelectResult,
  onDiscardResult,
}: MultiModelGenerationResultsProps) {
