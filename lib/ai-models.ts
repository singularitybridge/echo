...
export const MODEL_DEFINITIONS: Record<ImageEditingModel, ModelDefinition> = {
  ...
  'flux-2-dev': {
    ...
    icon: 'zap',
    speed: 'fast',
    tags: ['multi-image', 'local-edits'],
    description:
      'Lightweight multi-reference image editor for fast, professional edits using natural language prompts.',
    useCases: [
      'Multi-image composition and blending',
      'Background replacement with reference images',
      'Fast iteration on edits',
    ],
  ...
  'flux-2-pro': {
    ...
    icon: 'sparkles',
    speed: 'medium',
    tags: ['creative', 'content-preservation'],
    description:
      'High-fidelity production model with superior prompt adherence and realism for professional editing.',
    useCases: [
      'Production-quality image edits',
  ...
  'flux-2-max': {
    ...
    tags: ['creative', 'content-preservation'],
    description:
      'State-of-the-art model for advanced editing with exceptional realism and detail preservation.',
    useCases: [
      'Complex scene modifications',
      'Ultra-high quality edits',
      'Advanced creative transformations',
    ],
  ...
  'flux-2-flex': {
    ...
    icon: 'target',
    speed: 'medium',
    tags: ['creative', 'content-preservation', 'local-edits'],
    description:
      'Flexible editing with adjustable quality/speed tradeoff. Excels at multi-reference editing, typography, and precise parameter control.',
    useCases: [
      'Fine-tuned quality vs speed tradeoffs',
      'Multi-reference image editing',
      'Typography and text modifications',
    ],
  ...
  'gpt-image-1.5': {
    ...
    icon: 'sparkles',
    speed: 'medium',
    tags: ['creative', 'text-precision', 'content-preservation'],
    description:
      'Enhanced GPT image model with improved editing capabilities, better content preservation and more realistic outputs.',
    useCases: [
      'Advanced photorealistic edits',
      'Complex scene modifications',
      'Professional content creation',
    ],
    estimatedTimeSeconds: 7.0,
    colorAccent: 'sky',
  },
  'qwen-edit-2509': {
    id: 'qwen-edit-2509',
    ...
    icon: 'type',
    speed: 'medium',
    tags: ['text-precision', 'multi-image', 'local-edits'],
    description:
      'Enhanced Qwen model with improved text editing, multi-image support, and layered modifications without altering surroundings.',
    useCases: [
      'Precise text replacement with context preservation',
      'Multi-image reference editing',
      'Layered modifications preserving backgrounds',
    ],
    estimatedTimeSeconds: 4.0,
    colorAccent: 'fuchsia',
  },
